...
public class ModCompostable {
    public static void register() {
        ...
        RegHelper.registerCompostable(ModBlocks.RED_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.ORANGE_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.YELLOW_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.LIME_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.GREEN_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.BLUE_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.LIGHT_BLUE_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.CYAN_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.PURPLE_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.MAGENTA_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.PINK_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.WHITE_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.BLACK_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.GRAY_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.LIGHT_GRAY_PRIMROSE.get()
                .asItem(), 0.2f);
        RegHelper.registerCompostable(ModBlocks.BROWN_PRIMROSE.get()
                .asItem(), 0.2f);
    }
}
